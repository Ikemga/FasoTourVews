...
const SitesDetail = ({site, onBack, onToggleSidebar, onDelete, onRefresh}) =>{
    ...
    console.log("SITE REÇU DANS DETAIL :", site);
    ...
    const openItineraire = () => {
        ...
        window.open(`https://www.google.com/maps/search/?api=1&query=${site.localisation}`, "_blank");
        }
    };
        ...
        <div >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w- mx-6">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <SiteInfoCard site={site} onItineraire={openItineraire} />
