...
const STATUTS = ["ACTIF", "INACTIF", "BROUILLON"] as const;

type StatutSite = typeof STATUTS[number];

interface Props {
    value: StatutSite;
    onChange: (value: StatutSite) => void;
}

const SelectStatutSite = ({ value, onChange }: Props) => {
...
export default SelectStatutSite;